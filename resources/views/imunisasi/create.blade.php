...
@section("title", "Tambah Data Imunisasi Anak")
@section("content")
<section>
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <h2 class="card-title fw-semibold mb-4">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            Tambah Data Imunisasi Anak <span class="badge rounded-pill text-bg-info">{{ $anak->nama }}</span>
                        </div>
                    </h2>
                    <div class="mt-4">
                        <form class="" method="post" action="{{ route('imunisasi.store', $id) }}">
                            @csrf
                            <div class="modal-body">
                                <div class="row gap-0 row-gap-3 mb-3">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        ...
                                        <input id="jenis_vaksin" class="form-control form-sm" name="jenis_vaksin" type="text" value="{{ old('jenis_vaksin') }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <h6><b>Tambahan</b></h6>
